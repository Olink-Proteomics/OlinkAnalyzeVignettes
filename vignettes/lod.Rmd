...
384/3072 datasets. Although it is recommended to use all Olink Explore and 
...
LOD can be added to Olink Explore or Reveal NPX datasets using `olink_lod()`. 
This function can calculate LOD from an NPX dataset using the dataset's negative
...
Olink Explore and Reveal data are delivered as either plate control (PC) 
