...
npx_data1_clean <- OlinkAnalyze::clean_npx(
  df = npx_data1,
  #Keeping duplicated SampleIDs because the sample controls in these datasets
  #have the same SampleIDs
...
npx_df_br_no_ctrl <- npx_df_br |>
  ...
  # Mark bridge samples with "Bridge" and other samples with "Sample"
  dplyr::mutate(
    Type = dplyr::if_else(
      .data[["SampleID"]] %in% .env[["overlapping_samples"]],
